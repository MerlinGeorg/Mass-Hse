            ...
            <div class="col-md-8">
              <div class="pull-xs-right" role="toolbar">
               ...
               <!--  <button class="btn btn-secondary" type="button" data-toggle="collapse" href="#qmenu" aria-expanded="false" aria-controls="qmenu">Open menu</button> -->
                <button class="btn btn-success" data-toggle="modal" data-target="#trackermodal"  onclick="clearall();">Register Course</button>
              </div>
            </div>
          </div>
        </div>
...
<div class="modal fade-scale" id="trackermodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          ...
          <div class="modal-body">
           <form method="POST" id="coursform"  >
                    ...
                    <div class="form-group col-sm-6">
                      <input type="hidden" id = 'corsid' name="corsid"/>
                      <h4 class="demo-sub-title">Course name</h4>
                      <input class="form-control focus " type="text" required="required" name="corsname" id="corsname">
                    </div>
                    <div class="form-group col-sm-6">
                      <h4 class="demo-sub-title">Category</h4>
                      <select class="form-control focus" name="corscat" id="corscat">
                        <option value="">Select</option>
                        <?php
                        foreach($courscat as $row){?>
                    ...
                    <div class="form-group col-sm-12">
                      ...
                      <h4 class="demo-sub-title">Course description</h4>
                      <textarea class="form-control focus" name="cousedesc" id="summernote" data-plugin="summernote"></textarea>
                    </div>
                    ...
                    <div class="form-group col-sm-12">
                     ...
                     <div class="form-group col-sm-6">
                      ...
                      <h4 class="demo-sub-title">Course Code</h4>
                      <input class="form-control focus " type="text" required="required" name="corscode" id="corscode">
                    </div> 

                    <div class="form-group col-sm-6">
                      <h4 class="demo-sub-title">Course Pic</h4>
                      <input class="form-control focus" type="file"   name="image_file"  id="course_file" >
     ...
     <script type="text/javascript">
      ...
      function getcourse(){
           $.ajax({
                method: "POST",
                url: "<?php echo base_url('index.php/Admin_course/display_course');?>/",
      ...
      function clearall(){
        $('#modalcaption').text("Register Course");
        $('#corsname').val('');
        $('#summernote').html('');
         $('#corsid').val('');
          $('#corscat').val('');
      ...
      $("#coursform").submit(function(e) {
        ...
        var form = $(this);
         $.ajax({
                method: "POST",
                url: "<?php echo base_url('index.php/Admin_course/reg_course');?>/",
      ...
      function editcourse(id){
        ...
        $.ajax({
              method: "POST",
              url: "<?php echo base_url('index.php/Admin_course/editcors');?>/",
             ...
             success: function(data)
            {
              ...
              // console.log(data);
              $('#corsid').val(res.id);
              $('#corsname').val(res.course);
              $('#corscat').val(res.course_cat);
              $('#summernote').val(res.course_desc);
              $('#corscode').val(res.course_code);
              
              
               $('#image1').val(res.course_pic); 
              $('#imagefill').html('<img  style="width:250px;height:200px;"src="<?php echo base_url();?>/uploads/'+res.course_pic+'">') 

            }
        });
      }
      
      function deletecourse(id,img){
        var result = confirm("Are you want to delete?");
          if (result) {
              $.ajax({
              method: "POST",
              url: "<?php echo base_url('index.php/Admin_course/deletecors');?>/",
