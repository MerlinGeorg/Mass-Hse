...
<html lang="en-us">
  ...
  <body onload="cert_request_count()" class="orchid mirage" style="overflow: visible;">
      ...
      <nav class="menu-block">
        <ul class="nav">
          <li class="nav-item mainmenu-user-profile">
              <div class="circle-box"><img src="<?php echo base_url(); ?>/1.jpg" alt="">
                <div class="dot dot-success"></div>
              </div>
              <div class="menu-block-label"><b>MASS </b><br>administrator</div></li>
        </ul>
        ...
        <ul class="nav">
          <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_category"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Course category</div></a></li>
          <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_board/react"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Course</div></a></li>
            
            <!-- <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_course" target="_blank"><i class="icon ion-ios-list-outline"></i>
              <div class="menu-block-label">Course</div></a></li> -->

              <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_college"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Student Admission</div></a></li>

              <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_companyinfo"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Company Register</div></a></li>

              <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Company_area"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Company certification</div></a></li>

              <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Idcard"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Student ID</div></a></li>

              <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Certification"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Student Certification</div></a></li>

              <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Study_meterial"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Study Meterials</div></a></li>

              <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Qpaper_code"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Question Paper</div></a></li>


              <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_qpaper"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Question Management</div></a></li>

              <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_xam"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Exam Result</div></a></li>

              <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/CertificationRequest"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Request<span class="label label-success" id="newspan123"></span></div></a></li>

              <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_zoomclass"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Meeting</div></a></li>

              <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_trainer"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Trainers</div></a></li>
              
              <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_services"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Service Management</div></a></li>

              <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Home_slider"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Home slider</div></a></li>
              <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Offer_banner"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Offer banner</div></a></li>
              <!-- <li class="nav-item"><a class="nav-link" href="#"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Accountant</div></a></li> -->

              <!-- <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_fees"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Fees</div></a></li> -->
           ...
           <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_board/do_logout"><i class="icon ion-android-people"></i>
          ...
          <li class="nav-item"><a class="nav-link" href="ui-widget.html"><i class="icon ion-pizza"></i>
              <div class="menu-block-label">Sub-categories</div></a></li>
          <li class="menu-block-has-sub nav-item"><a class="nav-link" href="#"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Products<span class="label label-success">new</span></div></a>
      ...
      <div class="view-wrapper">
        ...
        <div class="topbar-wrapper">
          ...
          <div class="topbar-wrapper-mobile-nav"><a class="topbar-togger js-minibar-toggler" href="#"><i class="icon ion-ios-arrow-back hidden-md-down"></i><i class="icon ion-navicon-round hidden-lg-up"></i></a><a class="topbar-togger pull-xs-right hidden-lg-up js-nav-toggler" href="#"><i class="icon ion-android-person"></i></a>
            ...
            --><a class="topbar-wrapper-logo demo-logo" href="index.html">Mass</a>
          </div>
          <!-- END NAV FOR MOBILE-->
