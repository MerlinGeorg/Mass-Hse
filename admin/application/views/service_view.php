...
<div class="modal fade-scale" id="trackermodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
           ...
           <form method="POST" id="serviceform">
              ...
              <div class="row m-b-2">
                    ...
                    <div class="form-group col-sm-6">
                      ...
                      <input class="form-control focus" type="text" required="required" name="servicename" id="servicename">
                    </div>
                     
                     <div class="form-group col-sm-6">
                      <h4 class="demo-sub-title">Service Image</h4>
                     ...
                     <div class="form-group col-sm-6">
                      ...
                      <textarea rows="6" class="form-control focus" name="servdesc" id="servdesc"></textarea>
                    </div>
     ...
     <script type="text/javascript">
      ...
      function gtservice(){
           $.ajax({
                method: "POST",
                url: "<?php echo base_url('index.php/Admin_services/display_service');?>/",
      ...
      $("#serviceform").submit(function(e) {
        ...
        var form = $(this);
         $.ajax({
                method: "POST",
                url: "<?php echo base_url('index.php/Admin_services/add_service');?>/",
      ...
      function editservice(id){
        // alert(id);
        $('#modalcaption').text("Edit Service");
        $.ajax({
              method: "POST",
              url: "<?php echo base_url('index.php/Admin_services/editservice');?>/",
             ...
             success: function(data)
             {
              ...
              gtservice();
              // console.log(data);
              $('#servid').val(res.service_id);
              $('#servicename').val(res.service_name);
              $('#servdesc').val(res.service_desc);
              

               
              

              $('#image1').val(res.service_image); 
              $('#imagefill').html('<img  style="width:250px;height:200px;"src="<?php echo base_url();?>/uploads/'+res.service_image+'">') 
      ...
      function deleteservice1(id,img){
        var result = confirm("Are you want to delete?");
          if (result) {
              $.ajax({
              method: "POST",
              url: "<?php echo base_url('index.php/Admin_services/delete_service');?>/",
