  ...
  <head>
    ...
    <body class="cadetblue login login-transparent">
      <div class="col-md-12" style="text-align: center; color: white;margin-top: 50px; margin-bottom: 20px" >
        <h1>Mass</h1>
        <h4>HSE Consultant Co.</h4>

      </div>
      <form class="login-form widget" id="userlogin" autocomplete="off" action="<?php echo base_url(); ?>index.php/Admin_board/login_admin" method="POST">
