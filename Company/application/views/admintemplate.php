    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item ">
            <a href="<?php  echo base_url()?>index.php/Company_profile" class="nav-link active">
          ...
          <li class="nav-item">
            <a href="<?php  echo base_url()?>index.php/Company_certification" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="<?php  echo base_url()?>index.php/Company_login/st_logout" class="nav-link">
