...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>MASS HSE Consultent Co</b> Company</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form autocomplete="off" action="<?php echo base_url(); ?>index.php/Company_login"
       method="post">
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="Your registrade mailid" name="inputUsername">
        ...
        <div class="row">
          ...
          <!-- /.col -->
         <!--  <div class="col-4">
            <a href="<?php echo base_url(); ?>index.php/Student_register"><b title="click to register if you dont have an accont" class="btn btn-success btn-block">Register</b></a>
          </div> -->
          <!-- /.col -->
     ...
     <!--  <p class="mb-1">
      ...
      <p class="mb-0">
        <p class="text-center">click registration button if you don't have an account</p>
      </p> -->
    </div>
    <!-- /.login-card-body -->
  </div>
