      ...
      <div class="card card-solid">
        <div class="card-body pb-0">
          ...
          <div class="col-md-12" style="text-align: center;margin-bottom: 30px;margin-top: 30px">
            <u><h1 style="width: 100%;font-style: inherit;font-size: 42">Check your active courses.</h1></u>
          </div> 
...
<?php
 ...
 foreach($mycors as $row){  

  if($row->course=='')
  { ?>

  
  <p  class="col-md-12" style="text-align: center;margin-top: 20px">No Active courses</p>
              ...
              <div class="card bg-light">
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    ...
                    <div class="col-12 " style="text-align: center;margin-top: 10px">
                      <h3 class="lead"> Price:&nbsp;<span style="color: red;font-style: inherit;"> <b><?php echo $row->checkouts_price; ?></b></span></h3>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-footer">
                  ...
                  <div class="col-md-12" >
                   ...
                   <h3>Expiry : <span style="color: red" id="expspan"><b><?php echo $row->checkouts_expdate; ?></b></span></h3>
                  </div>
