			...
			onrendered:function(canvas)
			{
             ...
             success: function(data){
              ...
              if($.trim(data)=="success")
              {
              	...
              	window.location.href="https://localhost/mass/admin/index.php/Idcard";
              }
...
<div id="page3-div" style="position:relative;width:268px;height:383px;margin-left: auto;margin-right: auto;border:3px solid black;">

   <?php 


     $pass_no = $_POST['idpassno'];
       $st_name= $_POST['idname'];
       $topic = $_POST['idcorse'];
       $t_code= $_POST['idtraincode'];
       $comp_date= $_POST['idcomdate'];
       $image_name= $_POST['uploaded_image_name'];
   ?>
...
<div style="margin-left: 0;padding-left: 0">
	...
	<p style="position:absolute;top:149px;left:2px;white-space:nowrap" class="ft34"><b>&#160;&#160;MR.&#160;<span style="font-size: 11px"><?php echo $st_name; ?></span>&#160;</b></p>

	<p style="position:absolute;top:164px;left:2px;white-space:nowrap" class="ft34"><b>&#160;&#160;Passport&#160;NO.</b>&#160;<span id="cand_passport"><?php echo $pass_no; ?></span>&#160;</p>
...
<p style="position:absolute;top:212px;left:2px;white-space:nowrap;" class="ft33">&#160;&#160;<span id="cand_course" style="max-width:160px"><?php echo $topic; ?></span>&#160;</p>

	<p style="position:absolute;top:227px;left:2px;white-space:nowrap" class="ft33">&#160;&#160;Training&#160;code : &#160;<?php echo $t_code; ?>&#160;</p>

	<p style="position:absolute;top:243px;left:2px;white-space:nowrap" class="ft33">&#160;&#160;Training&#160;course&#160;&#160;</p>

	<p style="position:absolute;top:258px;left:2px;white-space:nowrap" class="ft33">&#160;&#160;Completion&#160;Date :&#160;<?php echo $comp_date; ?>&#160;</p>
</div>
<div>
...
<div>
    ...
    left: 94px;height: 90px;width: 80px;border:1px solid black" src="admin/uploads/<?php echo $image_name; ?>" alt="background image"/>
</div>
<div>
	<img style="    position: absolute;
    margin-top: 350px;
